...
import 'package:route_spatial_index/src/models/line_segment.dart';
import 'package:route_spatial_index/src/models/cluster_data.dart';
import 'package:route_spatial_index/src/models/point_with_distance.dart';
import 'package:route_spatial_index/src/utils/geo_utils.dart';
...
void main() {
  ...
  group('Point with Distance', () {
    ...
    test('SegmentPointWithDistance - constructor and properties', () {
      final point = LatLng(1.0, 2.0);
      final segmentPoint = SegmentPointWithDistance(
        point, 
        42.0, 
        segmentIndex: 5, 
        subSegmentIndex: 10
